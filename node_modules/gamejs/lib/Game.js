...
Game.prototype._setNextPlayer = function() {
    ...
    let playerIndex=this.players.indexOf(this._player);
    playerIndex++;if(playerIndex>=this.players.length)playerIndex=0;
	var playerNext=this.players[playerIndex];
	this._player=playerNext;
